...
object RabbitBossLifeHud {
    ...
    private fun drawBackplate(graphics: GuiGraphics, x: Int, y: Int, width: Int, height: Int) {
    ...
    private fun drawPixelHeart(graphics: GuiGraphics, x: Int, y: Int, filled: Boolean) {
    ...
    private fun drawGlitch(graphics: GuiGraphics, x: Int, y: Int, width: Int, height: Int) {
        repeat(5) {
